        ...
        <div className="mt-14 grid gap-6 lg:grid-cols-5">
          <div className="reveal grid gap-5 lg:col-span-2">
            <Card
              icon={MapPin}
              title="Address"
              lines={["Opposite Robertsonpet Police Station", "Oorgaumpet, KGF, Karnataka 563122"]}
            />
            <Card
              icon={Phone}
              title="Reservations"
              lines={["+91 8153 123456", "+91 98765 43210"]}
            />
            <Card icon={Mail} title="Email" lines={["concierge@alnaaz.com", "events@alnaaz.com"]} />
            <Card
              icon={Clock}
              title="Opening Hours"
              lines={["Mon — Sun · 12:00 — 23:30", "Friday · 13:30 — 23:30"]}
            />
    ...
    <div className="hover-lift glass rounded-2xl p-5">
      <div className="flex items-start gap-4">
        ...
        <div>
          ...
          {lines.map((l) => (
            <p key={l} className="mt-1 text-sm text-foreground/85">
              {l}
            </p>
          ))}
        </div>
